...
exports.groupsRelations = exports.friendsRelations = exports.usersRelations = exports.FriendGroups = exports.groups = exports.friends = exports.users = void 0;
...
exports.usersRelations = (0, drizzle_orm_1.relations)(exports.users, function (_a) {
    var many = _a.many;
    return ({
        friends: many(exports.friends, { relationName: "Id of user who created friend" }),
        questions: many(question_1.questions, {
            relationName: "Id of user who created question",
        }),
        tags: many(question_1.tags, { relationName: "Id of user who created tag" }),
    });
});
