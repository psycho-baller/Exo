...
const Component: FC<Props> = (props) => {
  ...
  const deleteQuestionMutation = api.group.delete.useMutation({
  ...
  return (
    <GestureHandlerRootView>
      <Swipeable
        ...
        onSwipeableOpen={() => deleteQuestionMutation.mutate(group.id)}
        enabled={true}
          ...
          >
            <YStack gap={6}>
              ...
              <XStack gap={18}>
                ...
                {/* <PersonOrGroupForQuestion group={group} /> */}
              </XStack>
            </YStack>
          </XStack>
        </Link>
...
function PersonOrGroupForQuestion(props: { group: RouterOutputs['group']['all'][number] }) {
  const { group } = props;
