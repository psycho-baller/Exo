...
import { people } from '../../../local-db/schema'
import type { NewPerson, Person, UpdateTable, WithId } from '../../../local-db/schema/types'
import { insertPersonSchema } from '../../../local-db/schema/types'
import { z } from 'zod'
